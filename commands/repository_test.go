			...
			loadLines: func(path string) ([]string, error) {
				...
				case "root/.arciv/list/77777777-7777777777777777777777777777777777777777777777777777777777777777":
					return []string{
						...
						"+ 7777777777777777777777777777777777777777777777777777777777777777 77777777 7777/7777",
					}, nil
				case "root/.arciv/list/88888888-8888888888888888888888888888888888888888888888888888888888888888":
					return []string{
						...
						"+ 8888888888888888888888888888888888888888888888888888888888888888 88888888 8888/8888",
					}, nil
				case "root/.arciv/list/99999999-9999999999999999999999999999999999999999999999999999999999999999":
					return []string{
						...
						"+ 9999999999999999999999999999999999999999999999999999999999999999 99999999 9999/9999",
					}, nil
				default:
					t.Errorf("fileOp.loadLines is called with unknown path \"%s\"", path)
					panic("")
			...
			writeLines: func(path string, lines []string) error {
				...
				case "root/.arciv/list/aaaaaaaa-aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa":
					if len(lines) != 12 ||
						...
						lines[2] != "1111111111111111111111111111111111111111111111111111111111111111 11111111 1111/1111" ||
						lines[3] != "2222222222222222222222222222222222222222222222222222222222222222 22222222 2222/2222" ||
						lines[4] != "3333333333333333333333333333333333333333333333333333333333333333 33333333 3333/3333" ||
						lines[5] != "4444444444444444444444444444444444444444444444444444444444444444 44444444 4444/4444" ||
						lines[6] != "5555555555555555555555555555555555555555555555555555555555555555 55555555 5555/5555" ||
						lines[7] != "6666666666666666666666666666666666666666666666666666666666666666 66666666 6666/6666" ||
						lines[8] != "7777777777777777777777777777777777777777777777777777777777777777 77777777 7777/7777" ||
						lines[9] != "8888888888888888888888888888888888888888888888888888888888888888 88888888 8888/8888" ||
						lines[10] != "9999999999999999999999999999999999999999999999999999999999999999 99999999 9999/9999" ||
						lines[11] != "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa aaaaaaaa aaaa/aaaa" {
						t.Errorf("fileOp.writeLines is called with unknown lines %s", lines)
					}
					return nil
				default:
